...
<div class="page-header">
    <h1>Гардероб<small> Верхняя одежда </small></h1>
</div>
        ...
        <div class="btn-toolbar" role="toolbar">
            <%--<div class="btn-group">--%>
                ...
                <form action="addOuterwear.do">
                    <button type="submit" class="btn btn-default" style="width: 255px; height: 35px">Добавить верхнюю одежду</button>
                ...
                <form action="fashionOuterwears.do">
                    <button type="submit" class="btn btn-default" style="width: 255px; height: 35px">Модная верхняя одежда</button>
                </form>
            </div>
        </div>
    </div>
